  ...
  <div class="content-card">
    <form method="POST" action="{{ route('services.update', $service) }}">
      ...
      <div style="margin-bottom:1rem; display:flex; align-items:center; justify-content:space-between;">
        <div>
          <h1>Edit Layanan</h1>
          <div class="subtitle">Perbarui layanan booking.</div>
        </div>
      ...
      <div class="form-grid">
        ...
        <div class="col-12">
          <div class="field">
            ...
            <textarea id="description" name="description" style="width:100%; border:1px solid #cbd5e1; border-radius:12px; padding:.75rem .9rem;">{{ old('description', $service->description) }}</textarea>
          </div>
        </div>
        <div class="col-12">
          <div class="field">
            <label><input type="checkbox" name="is_active" value="1" {{ old('is_active', $service->is_active) ? 'checked' : '' }}> Aktif</label>
          </div>
        </div>
      </div>
      <div class="actions">
