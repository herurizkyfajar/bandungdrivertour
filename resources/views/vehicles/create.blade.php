@extends('layouts.app', ['title' => 'Tambah Kendaraan'])
      ...
      <div class="form-grid">
        ...
        <div class="col-6">
          <div class="field">
            ...
            <div class="search-select" id="mitra_select">
              ...
              <div id="mitra_hidden_inputs"></div>
        ...
        <div class="col-6">
          <div class="field">
            ...
            <input id="price_per_day" type="text" inputmode="numeric" name="price_per_day" value="{{ old('price_per_day') }}" placeholder="contoh: 1.000.000">
          </div>
